...
namespace PlexureAPITest
{
    public class Service : IDisposable
    {
        ...
        public void addToken()
        {
            ...
            client.DefaultRequestHeaders.Add("x-auth-key", "37cb9e58-99db-423c-9da5-42d5627614c5");
        }
          ...
          //client.DefaultRequestHeaders.Add("x-auth-key", "37cb9e58-99db-423c-9da5-42d5627614c5");
                ...
                
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    //client.DefaultRequestHeaders.Add("token", user.AccessToken);
                    //client.DefaultRequestHeaders.Add("token", purchase.access);
        ...
        public Response<PointsEntity> GetPoints(int product_id)
        {
         ...
         //   client.DefaultRequestHeaders.Add("x-auth-key", "37cb9e58-99db-423c-9da5-42d5627614c5");
            ...
            using (var response = client.GetAsync($"api/points?product_id={product_id}").Result)
            {
                if (response.IsSuccessStatusCode)
                {
                    var points = JsonConvert.DeserializeObject<PointsEntity>(response.Content.ReadAsStringAsync().Result);
